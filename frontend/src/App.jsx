...
class ErrorBoundary extends Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-red-50 grid place-items-center p-8">
          <div className="max-w-md bg-white rounded-2xl p-8 shadow border border-red-100">
            ...
            <pre className="bg-slate-100 p-4 rounded text-xs overflow-auto">{this.state.error?.toString()}</pre>
          </div>
        </div>
      );
    }
